...
public class NearbyContract {
    ...
    public interface Presenter extends IPresenter {
        void searchTweets(String query, double latitude, double longitude);

        void getFreshTweets(String query, long since_id, double latitude, double longitude);

        void getNextTweets(String query, long max_id, double latitude, double longitude);
